...
--
-- Table structure for table `noticenews_board`
--

DROP TABLE IF EXISTS `noticenews_board`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `noticenews_board` (
  `noticenews_no` int(11) NOT NULL DEFAULT '0',
  `type` varchar(100) DEFAULT NULL,
  `title` varchar(1000) DEFAULT NULL,
  `views` varchar(1000) DEFAULT NULL,
  PRIMARY KEY (`noticenews_no`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `noticenews_board`
--

LOCK TABLES `noticenews_board` WRITE;
/*!40000 ALTER TABLE `noticenews_board` DISABLE KEYS */;
/*!40000 ALTER TABLE `noticenews_board` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `pay` (
  ...
  `cardco` varchar(100) DEFAULT NULL,
  `cardnum` varchar(100) DEFAULT NULL,
  `privateid` varchar(100) DEFAULT NULL,
  `movieid` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`payid`),
  KEY `pay_FK` (`privateid`),
  KEY `pay_FK_1` (`movieid`),
  CONSTRAINT `pay_FK` FOREIGN KEY (`privateid`) REFERENCES `member` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `question_board` (
  `memberid` varchar(100) NOT NULL DEFAULT '0',
  `type` varchar(100) DEFAULT NULL,
  `title` varchar(100) DEFAULT NULL,
  `content` varchar(1000) DEFAULT NULL,
  PRIMARY KEY (`memberid`),
  CONSTRAINT `question_board_FK` FOREIGN KEY (`memberid`) REFERENCES `member` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-02-22 18:28:06
